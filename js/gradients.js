...
//  Version: 1.2
var gradients = (function( window, angular ) {
	...
	var LYR1_CLR1 = "rgba(150,255,255,1)",
		...
		cache = window.localStorage ? window.localStorage : {},
	...
	function size ( val, isPercentage ) {
		var self = range({
			val: val ? val : 50,
			min: 0,
			max: 500
	...
	app.controller('ColorCtrl', function( $scope ) {
		...
		$scope.showCSS = function() {
			var css = "background: " + this.bgImage + "background-size: " +
					this.bgSize + ";";
